...
def get_transcript(comics_file, keys_obj):
    ...
    transcript = "Hi, I am gonna help you read this comics story: " + title + ". Here's what will happen: For each scene, I am gonna call out what I see in the image, and then I will transcribe the scene. Rest, I am gonna leave to your imagination. Since, we are going to read the comics, imagine each charater I call out as a cartoon. So, let's get started. " + scenes
    return transcript
